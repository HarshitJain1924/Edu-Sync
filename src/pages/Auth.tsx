  ...
  const handleOAuthLogin = async (provider: "google" | "github") => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error?.message ||
          "OAuth provider is not configured. Enable it in Supabase Authentication > Providers.",
        variant: "destructive",
      });
        ...
        <div className="bg-white/80 dark:bg-[#0a0a0c]/80 backdrop-blur-3xl rounded-[2rem] border border-slate-200 dark:border-white/[0.06] p-8 md:p-10 shadow-xl dark:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] transition-all duration-500 hover:shadow-2xl dark:hover:shadow-[0_40px_80px_-20px_rgba(204,151,255,0.1)] relative overflow-hidden">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 rounded-xl py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/10 hover:border-slate-300 dark:hover:border-white/20 transition-all duration-300 shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
            >
              ...
              {oauthLoadingProvider === "google" ? "Redirecting..." : "Google"}
            </button>
            <button
              type="button"
            ...
            >
              ...
              {oauthLoadingProvider === "github" ? "Redirecting..." : "GitHub"}
            </button>
          </div>
        </div>
