...
const JobDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex relative overflow-x-hidden">
      ...
      <main className="ml-64 flex-1 relative z-10 overflow-x-hidden">
        {/* Sticky Header */}
        <div className="sticky top-0 z-30 bg-[#0f172a]/80 backdrop-blur-xl border-b border-white/10 px-8 py-4 flex items-center justify-between shadow-2xl">
          <Button 
            variant="ghost" 
          ...
          <div className="flex gap-3">
            <Button variant="outline" size="icon" className="bg-white/5 border-white/10 text-gray-400">
        ...
        <div className="p-8 max-w-5xl mx-auto">
          {/* Hero Section */}
          <div className="bg-gradient-to-br from-white/[0.12] via-white/[0.05] to-transparent border border-white/20 rounded-[2.5rem] p-10 mb-10 shadow-2xl shadow-emerald-500/5 overflow-hidden relative group hover:border-emerald-500/40 transition-all duration-700">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
              {job.company_logo_url ? (
                <div className="w-24 h-24 rounded-2xl overflow-hidden bg-white/10 flex items-center justify-center p-2 border border-white/5 shadow-2xl">
              ...
              <div className="flex-1">
                ...
                <h1 className="text-5xl font-extrabold text-white mb-6 leading-tight tracking-tight">{job.title}</h1>
                
                <div className="flex flex-wrap gap-4 text-white/90">
                  <div className="flex items-center gap-2.5 px-4 py-2 rounded-2xl bg-white/10 border border-white/10 shadow-lg backdrop-blur-sm">
            ...
            {job.salary && (
              <div className="mt-8 pt-8 border-t border-white/5 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400 font-medium">Expected Salary</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 pb-32">
            ...
            <div className="lg:col-span-2 space-y-10">
              <section className="bg-white/[0.12] border border-white/[0.2] rounded-[2rem] p-10 backdrop-blur-md shadow-2xl relative overflow-hidden group">
                ...
                <div 
                  className="prose prose-invert prose-emerald max-w-none leading-[1.8] font-medium job-description-html text-lg text-gray-200"
              ...
              {job.tags && job.tags.length > 0 && (
                <section>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {job.tags.map(tag => (
                      <span key={tag} className="px-4 py-2 rounded-xl bg-white/5 text-gray-300 border border-white/5 font-medium hover:bg-white/10 transition-colors">
                        {tag}
                      </span>
                    ))}
                  </div>
            ...
            <div className="space-y-6">
              <div className="bg-white/10 border border-white/20 rounded-3xl p-6 backdrop-blur-sm shadow-xl">
                <h3 className="text-white font-bold text-lg mb-4 flex items-center gap-2">
                  <Filter className="h-5 w-5 text-emerald-400" />
                  Quick Info
                </h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-base py-3 border-b border-white/10">
                    <span className="text-gray-400 font-medium">Type</span>
                    <span className="text-white font-bold bg-white/5 px-3 py-1 rounded-lg">Full Time</span>
                  </div>
                  <div className="flex items-center justify-between text-base py-3 border-b border-white/10">
                    <span className="text-gray-400 font-medium">Model</span>
                    <span className="text-white font-bold bg-white/5 px-3 py-1 rounded-lg">{job.location === "Remote" ? "WFH" : "In-Office"}</span>
                  </div>
                  <div className="flex flex-col gap-2 pt-2">
                    <span className="text-gray-400 font-medium text-sm">Security Check</span>
              ...
              <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 rounded-3xl p-6">
                ...
                <p className="text-gray-400 text-sm mb-6">Double check your resume before applying to increase your chances!</p>
